...
public class TestGenerico {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Busco ancentros de raiz deberia dar vacio: " + a.ancestro(10).toString());
        System.out.println("Busco ancentros de 3 deberia dar 9 - 10 : " + a.ancestro(3).toString());
        System.out.println("Busco ancentros de 40 deberia dar  30 - 15 - 10  : " + a.ancestro(40).toString());
        System.out.println("Busco ancentros de elemento inexistente deberia dar vacio: " + a.ancestro(3333).toString());
        ...
        System.out.println((int) a.grado() );
